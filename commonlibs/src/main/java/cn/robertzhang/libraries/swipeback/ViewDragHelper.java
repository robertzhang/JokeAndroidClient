...
package cn.robertzhang.libraries.swipeback;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link cn.robertzhang.libraries.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link cn.robertzhang.libraries.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link cn.robertzhang.libraries.swipeback.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
