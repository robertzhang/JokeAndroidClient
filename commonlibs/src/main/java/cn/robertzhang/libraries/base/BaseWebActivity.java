...
import cn.robertzhang.libraries.widgets.BrowserLayout;
...
public class BaseWebActivity extends BaseSwipeBackCompatActivity {
    ...
    public static final String BUNDLE_KEY_SYSTEMBAR_TINTDRAWABLE = "BUNDLE_KEY_SYSTEMBAR_TINTDRAWABLE";

    private String mWebUrl = null;
    private String mWebTitle = null;
    private boolean isShowBottomBar = true;
    private int systemBarTintDrawable = -1;
    ...
    protected void getBundleExtras(Bundle extras) {
        ...
        systemBarTintDrawable = extras.getInt(BUNDLE_KEY_SYSTEMBAR_TINTDRAWABLE);
    }
...
//        setSystemBarTintDrawable(getResources().getDrawable(systemBarTintDrawable));

        mToolBar = ButterKnife.findById(this, R.id.toolbar);
        mToolBar.setBackgroundResource(systemBarTintDrawable);
