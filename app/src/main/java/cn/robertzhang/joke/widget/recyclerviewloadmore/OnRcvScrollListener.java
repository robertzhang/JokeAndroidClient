 ...
 *
 * use code: https://github.com/tianzhijiexian/ExRecyclerView/blob/master/mylibrary/src/main/java/kale/ui/view/rcv/OnRcvScrollListener.java
 */
public abstract class OnRcvScrollListener extends RecyclerView.OnScrollListener {
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
        ...
        mFirstVisibleItemPosition = calculateFirstVisibleItemPos(TYPE_LINEAR,layoutManager,mFirstVisibleItemPosition);
