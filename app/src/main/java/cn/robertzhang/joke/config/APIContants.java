...
public class APIContants {
     ...
     * eg: http://m2.qiushibaike.com/article/list/suggest?count=20&page=1
     */
    public static final String URL_HOT_JOKE = "http://m2.qiushibaike.com/article/list/suggest";

    public static final String URL_NEWST_JOKE = "http://m2.qiushibaike.com/article/list/latest";

    public static final String URL_TRUTH_JOKE = "http://m2.qiushibaike.com/article/list/imgrank";
